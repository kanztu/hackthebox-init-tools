...
alias gobusterz="gobuster dir -x php,txt -w /opt/useful/SecLists/Discovery/Web-Content/raft-medium-directories-lowercase.txt -u "
...
cat <<EOF
    ...
    alias:
        ...
        nnmap="sudo nmap -T5 -sC -p- --min-rate=100  $targetip"
        nnmapf="sudo nmap -T5 -sC --min-rate=100  $targetip"
